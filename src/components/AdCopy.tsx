	...
	return (
		<div className="text_container">
			...
			<p className="main_text">
				...
				AdmissionsBOOX will seamlessly automate the
				admission process, enabling schools efficiently
				manage the entire admission life-cycle, from student
				application to on-boarding.
			</p>
